...
Gem::Specification.new do |spec| # rubocop:disable Metrics/BlockLength
  ...
  spec.homepage      = 'https://github.com/holywyvern/devise_jwt_controllers'
  spec.license       = 'Apache-2.0'

  spec.metadata['homepage_uri'] = spec.homepage
  spec.metadata['source_code_uri'] = 'https://github.com/holywyvern/devise_jwt_controllers'
  spec.metadata['changelog_uri'] = 'https://github.com/holywyvern/devise_jwt_controllers/CHANGELOG.md'
  ...
  spec.add_runtime_dependency 'activesupport',
                              Devise::JWT::Controllers::RAILS_MIN_VERSION,
                              Devise::JWT::Controllers::RAILS_MAX_VERSION
